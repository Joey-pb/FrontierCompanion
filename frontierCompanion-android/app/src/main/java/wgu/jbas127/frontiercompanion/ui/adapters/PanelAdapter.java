...
public class PanelAdapter extends ListAdapter<DisplayableItem, RecyclerView.ViewHolder> {
    ...
    class ActionViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(DisplayableItem.ActionItem item) {
            ...
            BottomNavigationView bottomNav = itemView.getRootView().findViewById(R.id.bottom_nav_view);
            if (bottomNav != null) {
    ...
    private void hideBottomNav(View itemView) {
        BottomNavigationView bottomNav = itemView.getRootView().findViewById(R.id.bottom_nav_view);
        if (bottomNav != null) {
